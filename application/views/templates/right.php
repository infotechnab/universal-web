...
<a href="#" title="samsung"><img src="<?php // base_url(); ?>content/data1/tooltips/samsung.jpg" alt="samsung"/>3</a>
...
{ ?>
    <img src="<?php echo base_url();?>uploads/<?php echo $image; ?>" alt="<?php echo $tital; ?>" style="max-height: 100%;"/>
<?php } ?>
...
<div class="clear" />
    <div class="credit"> Designed By: <img src="<?php echo base_url(); ?>content/images/salyaniTech.png" /> </div>
